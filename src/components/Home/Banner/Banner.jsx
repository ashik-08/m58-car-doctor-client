      ...
      <div className="carousel w-full">
        ...
        <div id="slide1" className="carousel-item relative w-full">
          ...
          <div className="text-white absolute transform -translate-y-1/2 left-2 top-1/2 md:left-20 lg:left-24">
            <h2 className="text-sm md:text-3xl lg:text-4xl xl:text-6xl font-bold">
            ...
            <span className="text-xs md:text-base lg:text-lg font-semibold space-x-2 md:space-x-5">
        ...
        <div id="slide5" className="carousel-item relative w-full">
          ...
          <div className="text-white absolute transform -translate-y-1/2 left-2 top-1/2 md:left-20 lg:left-24">
            ...
            <span className="text-xs md:text-base lg:text-lg semibold space-x-2 md:space-x-5">
              <button className="border border-white hover:border-special rounded-md px-2 py-1.5 md:px-5 md:py-3 hover:bg-special">
                Discover More
              </button>
              <button className="border border-white hover:border-special rounded-md px-2 py-1.5 md:px-5 md:py-3 hover:bg-special">
